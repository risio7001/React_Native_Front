        ...
        <ScrollView style={{ backgroundColor: 'white' }}>
            ...
            <View style={{ flexDirection: 'column', marginVertical: 10, marginHorizontal: 10, justifyContent: 'center' }}>
                    ...
                    <View>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginVertical: 10 }}>
                            <SelectDropdown
                                ...
                                buttonStyle={{ borderWidth: 1, borderRadius: 5, width:'25%', paddingLeft: 5, paddingHorizontal: 10, backgroundColor:'white' }}
                                buttonTextStyle={{ fontSize: 13, textAlign: 'left', fontWeight: 'bold', color: 'grey' }}
                                defaultValue={PhoneNumber[0]}
                            />
                            <TextInput
                                style={{ borderWidth: 1, borderRadius: 5, width:'35%', paddingLeft: 5, paddingHorizontal: 10 }}
                            />
                            <TextInput
                                style={{ borderWidth: 1, borderRadius: 5, width:'35%', paddingLeft: 5, paddingHorizontal: 10 }}
                            />
                        ...
                        <Pressable
                            ...
                            <Text style={{ alignSelf: 'center', fontSize: 18, color:'black', fontWeight: 'bold' }}>인증번호 받기</Text>
                        </Pressable>
                    </View>
                    :
                    <View>
                ...
                <Pressable
                    onPress={{}}
                    style={styles.button}>
                    <Text style={{ alignSelf: 'center', fontSize: 18, color: 'white', fontWeight: 'bold' }}>확인</Text>
                </Pressable>
            </View>
        </ScrollView>
    </>
