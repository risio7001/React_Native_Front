...
const Product_More_Words = ({ navigation }) => {
    ...
    const changeToggle = () => {
        ...
        switch (toggle) {
                            ...
                            <View style={{ flex: 1 }}>
                                <Checkbox
                                    ...
                                    onValueChange={() => {
                                        ...
                                        if (temp.some((element) => element.check === true)) {
                                            setDelBtn(true);
                                        } else {
                                            setDelBtn(false);
                                        }
            ...
            case 1:
                return <>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', backgroundColor: 'white', paddingLeft: 10, paddingVertical: 8 }}>

                        <View style={{ flex: 10, borderColor: 'white', color: 'white', borderRightWidth: 1, justifyContent: 'center', borderLeftWidth: 1 }}>
                            <Text style={{ alignSelf: 'center', borderColor: 'white', color: 'grey' }}>등록된 문구가 없습니다.</Text>
                        </View>
                    </View>
                </>
            case 2:
                return <>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', backgroundColor: 'white', paddingLeft: 10, paddingVertical: 8 }}>
                        <Text style={{ color: 'grey', flex: 1, alignSelf: 'center', paddingRight: 5 }}>No</Text>
    ...
    return <>
        ...
        <View style={{ paddingHorizontal: 10, paddingVertical: 10, flexDirection: 'row' }}>
            ...
            />
            <Pressable style={{ justifyContent: 'center', flex: 1, backgroundColor: '#7B7B7B', marginHorizontal: 5, borderRadius: 5 }}>
                <Text style={{ alignSelf: 'center', color: 'white', fontSize: 11 }}>등록</Text>
            </Pressable>
        </View>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#7B7B7B', paddingHorizontal: 10, paddingVertical: 10, marginVertical: 10 }}>
